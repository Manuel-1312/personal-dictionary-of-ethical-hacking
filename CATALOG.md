...
| `python/` | Scripts propios y helpers en Python | README + toolkit organizados por subcategorías (`parsers/`, `web/`, `forensics/`), con `ROADMAP.md`, requirements y comandos de ejemplo | Añadir más utilidades (más subcategorías, tests, wrappers CI, ejemplos y documentación por módulo) y documentar entornos virtuales |
