...
| `python/` | Scripts propios y helpers en Python | README + toolkit describiendo `log_parser.py`, `inventory_builder.py`, requirements, y comandos de ejemplo | Añadir más utilidades (parsers de Zeek, generadores de cheatsheets, wrappers CI) y documentar entornos virtuales |
