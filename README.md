...
- `powershell/` – automatización ligera para Windows organizada por `system/`, `files/`, `network/`, `reporting/` y `fun/`, útil para inventario, red local, reporting, tareas del sistema y helpers visuales.
