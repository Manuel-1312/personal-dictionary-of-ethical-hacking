...
- `exploitation/` – validación de hallazgos en laboratorio, privilege escalation y post-explotación controlada con subcarpetas `frameworks/`, `privilege_escalation/` y `post_exploitation/`.
