...
- `powershell/` – automatización ligera para Windows organizada por `system/`, `files/`, `network/`, `reporting/` y `fun/`, útil para inventario, red local, reporting y helpers visuales.
