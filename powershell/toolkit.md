...
| `system/hotfix_report.ps1` | `system/` | Exporta hotfixes instalados | `pwsh -File powershell/system/hotfix_report.ps1 -Output reports/hotfixes.csv` |
| `system/local_groups_report.ps1` | `system/` | Lista grupos locales | `pwsh -File powershell/system/local_groups_report.ps1 -Output reports/groups.csv` |
...
| `files/downloads_inventory.ps1` | `files/` | Inventario de la carpeta Descargas | `pwsh -File powershell/files/downloads_inventory.ps1 -Output reports/downloads.csv` |
| `files/top_largest_files.ps1` | `files/` | Top de archivos más grandes | `pwsh -File powershell/files/top_largest_files.ps1 -Path $HOME -Top 25` |
...
| `network/firewall_profile_report.ps1` | `network/` | Exporta perfiles de firewall | `pwsh -File powershell/network/firewall_profile_report.ps1 -Output reports/firewall.csv` |
| `network/wifi_profiles_list.ps1` | `network/` | Lista perfiles Wi-Fi | `pwsh -File powershell/network/wifi_profiles_list.ps1` |
| `network/share_report.ps1` | `network/` | Exporta recursos compartidos SMB | `pwsh -File powershell/network/share_report.ps1 -Output reports/shares.csv` |
...
| `reporting/html_list_from_csv.ps1` | `reporting/` | Convierte CSV a HTML simple | `pwsh -File powershell/reporting/html_list_from_csv.ps1 -Input reports/software.csv -Output reports/software.html` |
| `reporting/json_summary_card.ps1` | `reporting/` | Resumen corto de un JSON | `pwsh -File powershell/reporting/json_summary_card.ps1 -Input reports/network.json` |
...
| `fun/typewriter_banner.ps1` | `fun/` | Imprime texto tipo máquina de escribir | `pwsh -File powershell/fun/typewriter_banner.ps1 -Text "LAB READY"` |
| `fun/random_status_message.ps1` | `fun/` | Mensaje de estado aleatorio | `pwsh -File powershell/fun/random_status_message.ps1` |
